package com.nttdata.savingaccount.config;
...
public class SwaggerConfig {
  ...
  public static final Contact DEFAULT_CONTACT = new Contact("Emir Sanchez", "https://www.sanchezemir.com",
      "emir2104@gmail.com");
  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Cuentas de Ahorro WebFlux Api Documentation", "Cuentas de Ahorro WebFlux Api Documentation", "1.0",
